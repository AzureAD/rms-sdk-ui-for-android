...
import com.microsoft.rightsmanagement.ipcnotepadsample.MsipcTaskFragment.TaskStatus;
import com.microsoft.rightsmanagement.ipcnotepadsample.TextEditorFragment.TextEditorMode;
        ...
        MsipcTaskFragment.TaskEventCallback, ProgressDialogFragment.ProgressDialogEventListener
{
    ...
    {
        mMsipcTaskFragment.startMsipcCreatePolicy(true);
    }
    ...
    public void onSendMailButtonClick()
    {
        ...
        try
        {
            ...
            mMsipcTaskFragment.startContentProtection(rawData);
        }
    ...
    protected void onCreate(Bundle savedInstanceState)
    {
        ...
        if (savedInstanceState == null)
        {
            ...
            if ((action.compareTo(Intent.ACTION_VIEW) == 0) || (action.compareTo(Intent.ACTION_EDIT) == 0))
            {
                ...
                createTextEditorFragment(TextEditorMode.Enforced);
            }
            else if (action.compareTo(Intent.ACTION_MAIN) == 0)
            {
                createTextEditorFragment(TextEditorMode.NotEnforced);
            }
            else
            {
     ...
     */
    private void createTextEditorFragment(TextEditorMode editorMode)
    {
        ...
        if (mTextEditorFragment == null)
        {
            ...
            mTextEditorFragment = TextEditorFragment.newInstance(editorMode);
    ...
    private void handleUriInput(Uri uri) throws FileNotFoundException
    {
        ...
        if (App.isPTxtFile(originalFileName))
        {
            ...
            mMsipcTaskFragment.startContentConsumption(inputStream);
        }
    }
}
